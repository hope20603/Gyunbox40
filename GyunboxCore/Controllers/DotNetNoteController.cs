...
namespace GyunboxCore.Controllers
{
    public class DotNetNoteController : Controller
    {
        ...
        //공통 속성: 검색모드 : 검색 모드이면 true, 그렇지 않으면 false
        ...
        public IActionResult Index()
        {
            ...
            //100번째 페이지 보고 있다가 다시 리스트 왔을때 100번째 페이지 표시
        ...
        public IActionResult Create()
        {
            ...
            ViewBag.TitleDescription = "글쓰기 - 다음필드들을 채워주세요.";
        ...
        public async Task<IActionResult> Create(Note model, ICollection<IFormFile> files)
        {
            ...
            note.PostIp = HttpContext.Connection.RemoteIpAddress.ToString(); //IP주소
        ...
        {
            //넘어온 Id 값에 해당하는 레코드 하나 읽어서 Note클래스에 바인딩
            ...
            vm.NoteCommentList = _commentRepository.GeteNoteComments(note.Id);
            vm.BoardId = note.Id;
        ...
        public IActionResult Edit(int id)
        {
            ...
            ViewBag.TitleDescription = "글 수정 - 아래항목을 수정하세요.";
        ...
        {
            ViewBag.FormType = BoardWriteFormType.Modify;
            ViewBag.TitleDescription = "글수정 - 아래항목을 수정하세요.";
            ViewBag.SaveButtonText = "수정";
            ...
            else
            {
                ...
                if(strFileExt == ".gif" || strFileExt == ".jpg" || strFileExt == ".jpeg" || strFileExt == ".png")
                {
                    switch (strFileExt)
                    {
                        ...
                        case ".jpg":
                            strContentType = "image/jpg"; break;
                        case ".jpeg":
