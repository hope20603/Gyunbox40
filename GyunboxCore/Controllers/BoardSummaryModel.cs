    ...
    public class BoardSummaryRepository
    {
        public List<BoardSummaryModel> GetAll()
        {
            ...
            var lists = new List<BoardSummaryModel>()
            {
                ...
                new BoardSummaryModel{ Id = 2, Alias ="Free", Name="백두", Title="자유사항입니다.",PostDate=DateTime.Now},
                new BoardSummaryModel{ Id = 3, Alias ="Photo", Name="꺽정", Title="사진사항입니다.",PostDate=DateTime.Now},
                new BoardSummaryModel{ Id = 4, Alias ="Notice", Name="길동", Title="공지사항입니다.",PostDate=DateTime.Now}
            };
