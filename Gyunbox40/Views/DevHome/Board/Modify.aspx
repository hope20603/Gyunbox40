<%@ Page Title="" Language="C#" MasterPageFile="~/SiteBlog.Master" AutoEventWireup="true" CodeBehind="Modify.aspx.cs" Inherits="Gyunbox40.Views.DevHome.Board.Modify" ValidateRequest="false" %>
...
<%--            <asp:DropDownList ID="ddl_category" runat="server"></asp:DropDownList>--%>
        ...
        <div class="con_mid">
            <textarea name="ir1" id="ir1" rows="10" cols="100" value=""></textarea>
